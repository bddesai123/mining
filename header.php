...
<head>
  ...
  <title>BirdFly - Mining</title>
  <meta name="author" content="BirdFly" />
  <meta name="description" content="BirdFly - Mining & Gaming HTML Template" />
  <meta name="keywords" content="BirdFly - Mining & Gaming HTML Template" />
      ...
      <div class="widget footer-widget">
        <div class="th-widget-about">
          <div class="about-logo">
            <a href="index.html"><span data-mask-src="assets/img/logo.png" class="logo-mask"></span>
              <img src="assets/img/logo.png" alt="BirdFly" /></a>
          </div>
          <p class="about-text">
            BirdFly is revolutionizing sustainable crypto mining, making it
            accessible to all! Join us in our mission to democratize crypto
            mining and promote a greener future.
          </p>
          ...
          <div class="th-widget-contact">
            <div class="th-social style-mask">
              <a class="facebook" href="https://www.facebook.com/profile.php?id=61558653616701"><i class="fab fa-facebook-f"></i></a>
              <a class="twitter" href="https://twitter.com/birdfly_org"><img src="assets/img/icon/x-twitter-icon.svg" alt="icon" /></a><a class="instagram" href="https://www.instagram.com/birdfly.mining?igsh=eXlldDR6MXUwb25h"><img src="assets/img/icon/instagram-icon.svg" alt="icon" /> </a><a class="linkedin" href="https://www.linkedin.com/company/birdfly/?viewAsMember=true"><i class="fab fa-linkedin"></i></a>
              <a class="google-play" href="https://www.google.com/"><img src="assets/img/icon/google-playstore-icon.svg" alt="icon" /></a>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="recent-post-wrap">
              ...
              <div class="media-body">
                <h4 class="post-title">
                  <a class="text-inherit" href="blog-details.html"
                    >A Day in the Life of an Mining Event & Enjoy</a
                  >
                </h4>
                <div class="recent-post-meta">
                  <a href="#"
                    ><i class="fa-light fa-calendar"></i>30 Nov, 2024</a
                  >
                </div>
              </div>
            </div>
            <div class="recent-post">
              ...
              <div class="media-body">
                <h4 class="post-title">
                  <a class="text-inherit" href="blog-details.html"
                    >Strategies for Dominating Your Favorite Game</a
                  >
                </h4>
                <div class="recent-post-meta">
                  <a href="#"
                    ><i class="fa-light fa-calendar"></i>05 Dec, 2024</a
                  >
                </div>
              </div>
            </div>
            <div class="recent-post">
              ...
              <div class="media-body">
                <h4 class="post-title">
                  <a class="text-inherit" href="blog-details.html"
                    >Behind the Scenes of Your Favorite Game</a
                  >
                </h4>
                <div class="recent-post-meta">
                  <a href="#"
                    ><i class="fa-light fa-calendar"></i>09 Sep, 2024</a
                  >
                </div>
              </div>
            </div>
  ...
  <div class="th-menu-wrapper">
    <div class="th-menu-area text-center">
      ...
      <div class="mobile-logo">
        <a href="index.html"><span data-mask-src="assets/img/logo.png" class="logo-mask"></span><img src="assets/img/logo.png" alt="BirdFly" /></a>
      </div>
      <div class="th-mobile-menu">
        <ul>
          <li class="menu-item-has-children">
            ...
            <!-- <ul class="sub-menu">
                <li><a href="index.html">Home Mining</a></li>
        ...
        <div class="row justify-content-center justify-content-lg-between align-items-center gy-2">
              ...
              <ul>
                <li>
                  <div class="header-notice">
                    Welcome to our <a href="index.html">BirdFly</a> Mining
                    team
                  </div>
                </li>
                <li>
          ...
          <div class="col-auto">
            <div class="header-links">
              <ul>
                <li>
                  <a href="https://www.facebook.com/profile.php?id=61558653616701">Facebook</a>
                </li>
                <li><a href="https://twitter.com/birdfly_org">Twitter</a></li>
                <li><a href="https://www.pinterest.com/">Pinterest</a></li>
                <li>
                  <a href="https://www.instagram.com/birdfly.mining?igsh=eXlldDR6MXUwb25h">Instagram</a>
                </li>
              </ul>
            </div>
          </div>
            ...
            <div class="col-auto d-none d-xl-block">
              <div class="header-button">
                ...
                <div class="d-xxl-block d-none">
                  <a href="contact.html" class="th-btn"><i class="fa-brands fa-twitch me-1"></i>JOIN NOW</a>
                </div>
              </div>
            </div>
          </div>
